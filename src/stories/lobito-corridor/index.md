---
layout: story.njk
title: "The Lobito Corridor: Where Africa's Copper Flows"
region: "Africa"
type: "economy"
...
roughly 72% of the world's cobalt. The Copperbelt is landlocked,
...
The corridor's spine is the Benguela Railway: a roughly 1,300-kilometer line
...
close on July 31st 2026 at $786 million, of which $553 million comes from the
...
mineral-handling capacity roughly tenfold, to 4.6 million tons a year, and cut
...
A second, harder project would extend the corridor with roughly 830 kilometers
...
line is still out to engineering and construction bidding. Groundbreaking is
expected to begin in late 2026 or early 2027 and its own financing is not due to close until
2027.

Running the other way is TAZARA, the 1,860-kilometer railway China built in the
...
billion deal to modernize it. The result is a map on which the same
